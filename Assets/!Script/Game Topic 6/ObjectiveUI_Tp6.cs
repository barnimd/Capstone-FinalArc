...
/// <summary>
/// Topic 6 redesigned objective UI driver. Animates TWO panels built under
/// ObjectiveCanvas by ObjectiveRedesignSetup:
...
///
/// Drop-in for the old flow: implements IObjectivePanel (ShowObjective(string)),
/// so GameManager_Tp6 / Topic6ProgressionController can call it just like ObjectiveUI_Tp4.
/// The old ObjectivePanel is left untouched; callers prefer this when assigned.
/// </summary>
[DisallowMultipleComponent]
public class ObjectiveUI_Tp6 : MonoBehaviour, IObjectivePanel
{
    ...
    private void Resolve()
    {
        ...
        // Panels start inactive, so GameObject.Find won't see them — walk ObjectiveCanvas instead.
    ...
    // ── Helpers ────────────────────────────────────────────────────────────
    private static GameObject FindUnderCanvas(string childName)
    {
        var canvas = GameObject.Find("ObjectiveCanvas");
