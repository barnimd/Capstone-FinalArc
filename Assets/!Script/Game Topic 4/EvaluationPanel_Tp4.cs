...
public class EvaluationPanel_Tp4 : MonoBehaviour
{
    ...
    private void TampilkanSoal(int index)
    {
        ...
        var labelA = btnChoiceA.GetComponentInChildren<TMP_Text>();
        var labelB = btnChoiceB.GetComponentInChildren<TMP_Text>();
        if (labelA != null) labelA.text = $"A. {soal.choiceA}";
        if (labelB != null) labelB.text = $"B. {soal.choiceB}";
